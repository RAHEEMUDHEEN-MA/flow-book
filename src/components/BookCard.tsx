        ...
        >
          <div className="mb-3">
            <div className="flex items-start justify-between mb-1">
              <h3 className="text-lg font-semibold text-gray-900 pr-10">{book.name}</h3>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4 space-y-3">
                <div>
                  ...
                  <p className="text-sm text-gray-900">{formatDate(book.createdAt)}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{entries.length} {entries.length === 1 ? 'entry' : 'entries'}</p>
                </div>
                ...
                <div>
                  ...
                  <div className="text-sm space-y-1">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-green-600">₹{income.toLocaleString('en-IN')}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Expense:</span>
                      <span className="font-medium text-red-600">₹{expense.toLocaleString('en-IN')}</span>
                    </div>
